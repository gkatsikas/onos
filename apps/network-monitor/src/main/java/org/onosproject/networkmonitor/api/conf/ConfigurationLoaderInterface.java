...
public interface ConfigurationLoaderInterface {
    ...
    /**
     * Returns a Network Monitor configuration loaded from JSON.
     *
     * @param appId the application ID that requires this configuration
     * @return Network Monitor Configuration object
     */
    NetworkMonitorConfiguration loadNetworkMonitorConf(ApplicationId appId);
