...
package org.onosproject.networkmonitor.api.monitor;
...
public interface MonitorService {
     ...
     * This occurs when a Network Monitor configuration is received
     ...
     *
     * @param loadList list of Network Monitor metrics fetched from the database
     */
