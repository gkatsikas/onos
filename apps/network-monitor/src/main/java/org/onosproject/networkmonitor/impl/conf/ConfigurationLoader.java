...
import org.onosproject.networkmonitor.api.conf.ConfigurationLoaderInterface;
...
/**
 * Network Monitor configuration loader.
 */
public final class ConfigurationLoader
    ...
    /**
     * Network Monitor database configuration starts with this attribute.
     */
    private static final String DB_TITLE = "database";

    /**
     * Network Monitor database configuration attributes.
     */
    ...
    /**
     * Network Monitor prediction configuration starts with this attribute.
     */
    private static final String PRED_TITLE = "prediction";

    /**
     * Network Monitor prediction configuration
    ...
    /**
     * Returns Network Monitor configuration read from JSON.
     *
     * @return Network Monitor configuration
     */
    @Override
    public NetworkMonitorConfiguration loadNetworkMonitorConf(ApplicationId appId) {
        this.appId = appId;
        ...
        /**
         * Build the Network Monitor configuration.
         */
        URI id = null;
        try {
        ...
        checkNotNull(id, "Network Monitor configuration ID is NULL");

        NetworkMonitorConfiguration.Builder networkMonitorConfBuilder = NetworkMonitorConfiguration.builder()
            .id(id)
            .databaseConfiguration(dbConf)
            .ingressPoints(ingressPoints)
            .predictionConfiguration(predConf);

        NetworkMonitorConfiguration networkMonitorConf = networkMonitorConfBuilder.build();

        log.info("Successfuly loaded Network Monitor configuration: {}", networkMonitorConf.toString());

        return networkMonitorConf;
    }
