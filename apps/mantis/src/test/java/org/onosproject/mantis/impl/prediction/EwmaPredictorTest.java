...
/**
 * Unit test for the EWMA prediction mechanism.
 */
public class EwmaPredictorTest {
    ...
    public void testEwmaZeros() throws Exception {
        ...
        EwmaPredictor.Builder ewmaBuilder =
            EwmaPredictor.builder()
                ...
                .alphaDecayFactor(EwmaPredictor.DEF_EWMA_DECAY_ALPHA);

        predictedInputZeros = ewmaBuilder.build();
    ...
    public void testEwma() throws Exception {
        ...
        predictedInput = ewmaBuilder.build();
