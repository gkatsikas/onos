...
/**
 * Unit test for Mantis configuration loader.
 */
public class ConfigurationLoaderTest {
    ...
    public void testInvalidHeaderConfiguration() throws IOException, JsonProcessingException, Exception {
        ...
        try {
            invalidConfHeaderNode = sample.path(APPS)
                        .path(MantisConfigurationManager.APP_NAME)
                        .path(MantisConfigurationManager.CONFIG_TITLE);

            loader.init(
                appId,
                MantisConfigurationManager.CONFIG_TITLE,
    ...
    public void testValidConfiguration() throws IOException, IllegalArgumentException, Exception {
        ...
        MantisConfiguration mantisConf = loader.loadMantisConf(appId);
        // This object must not be NULL
        assertThat(mantisConf, notNullValue());
        assertThat(mantisConf.toString(), notNullValue());
    }
