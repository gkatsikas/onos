...
package org.onosproject.metron.web;
 ...
 */
@Path("/stats")
public class MetronStatsWebResource extends AbstractWebResource {

    private static final Logger log = getLogger(MetronStatsWebResource.class);

    /**
     * The label of this component.
     */
    private static final String APP_NAME = Constants.SYSTEM_PREFIX + ".web.stats";
