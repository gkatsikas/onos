...
/**
 * Modifier block that unstrips a number of bytes
 * from the front side of a packet's header.
 */
public class Unstrip extends ModifierBlock {
    ...
    /**
     * Default behavior assumes that we unstrip the Ethernet header.
     */
    private static final short DEF_LENGTH = Ethernet.ETHERNET_HEADER_LENGTH;
    ...
    public ProcessingBlockClass processingBlockClass() {
        return ProcessingBlockClass.UNSTRIP;
    }
