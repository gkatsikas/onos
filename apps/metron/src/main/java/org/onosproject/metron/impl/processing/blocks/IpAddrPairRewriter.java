...
/**
 * Modifier block that statefuly modifies src and dst IP addresses.
 */
public class IpAddrPairRewriter extends IpRewriter {

    public IpAddrPairRewriter(
            String id,
            String conf,
            String confFile) {
    ...
    public ProcessingBlockClass processingBlockClass() {
        return ProcessingBlockClass.IP_ADDR_PAIR_REWRITER;
    }
