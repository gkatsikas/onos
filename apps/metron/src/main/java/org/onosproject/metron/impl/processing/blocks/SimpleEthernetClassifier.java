...
/**
 * Classifier block that performs basic link layer traffic classification.
 */
public class SimpleEthernetClassifier extends ClassifierBlock {

    public SimpleEthernetClassifier(
            String id,
            String conf,
            String confFile) {
    ...
    public ProcessingBlockClass processingBlockClass() {
        return ProcessingBlockClass.SIMPLE_ETHERNET_CLASSIFIER;
    }
