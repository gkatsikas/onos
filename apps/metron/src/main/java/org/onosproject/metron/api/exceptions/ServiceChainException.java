...
/**
 * Exceptions related to service chains.
 */
public class ServiceChainException extends RuntimeException {
     ...
     */
    public ServiceChainException(String message) {
        super(message);
    }
     ...
     */
    public ServiceChainException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause the throwable cause
     */
    public ServiceChainException(String message, Throwable cause) {
        super(message, cause);
    }
