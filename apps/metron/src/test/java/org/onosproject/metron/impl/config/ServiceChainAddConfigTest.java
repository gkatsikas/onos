...
import org.onosproject.metron.impl.application.NfvApplicationManager;
...
/**
 * Unit test for adding service chain configurations.
 */
public class ServiceChainAddConfigTest {
     ...
     */
    private static final String INVALID_CONF_HEADER_FILE         = "invalid-add-conf-header.json";
    private static final String INVALID_CONF_CONTENT_TYPO_1_FILE = "invalid-add-conf-content-typo-1.json";
    private static final String INVALID_CONF_CONTENT_TYPO_2_FILE = "invalid-add-conf-content-typo-2.json";
    private static final String INVALID_CONF_CONTENT_TYPO_3_FILE = "invalid-add-conf-content-typo-3.json";
    private static final String INVALID_CONF_CONTENT_STRUCT_FILE = "invalid-add-conf-content-struct.json";
    private static final String VALID_CONF_FILE                  = "valid-add-conf.json";
    ...
    public void testInvalidHeaderConfiguration() throws IOException, JsonProcessingException, Exception {
        ...
        ServiceChainAddConfig loader = new ServiceChainAddConfig();

        try {
            invalidConfHeaderNode = sample.path(APPS)
                        .path(NfvApplicationManager.APP_NAME)
                        .path(NfvApplicationManager.ADD_CONFIG_TITLE);

            loader.init(
                appId,
                NfvApplicationManager.ADD_CONFIG_TITLE,
    ...
    public void testInvalidContentTypoOneConfiguration() throws IOException, JsonProcessingException, Exception {
        ...
        } catch (InvalidFieldException | IllegalArgumentException ifEx) {
            // Successfully caught invalid JSON
            return;
        }
    ...
    public void testValidConfiguration() throws IOException, IllegalArgumentException, Exception {
        ...
        Set<ServiceChainInterface> scConf = loader.loadServiceChains(appId);
        // This object must not be NULL
        assertThat(scConf, notNullValue());
        assertThat(scConf.toString(), notNullValue());
    }
