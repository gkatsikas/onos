...
/**
 * Unit test for removing service chain configurations.
 */
public class ServiceChainRemoveConfigTest {
     ...
     */
    private static final String INVALID_CONF_HEADER_FILE         = "invalid-rem-conf-header.json";
    private static final String INVALID_CONF_CONTENT_TYPO_1_FILE = "invalid-rem-conf-content-typo-1.json";
    private static final String INVALID_CONF_CONTENT_TYPO_2_FILE = "invalid-rem-conf-content-typo-2.json";
    private static final String INVALID_CONF_CONTENT_TYPO_3_FILE = "invalid-rem-conf-content-typo-3.json";
    private static final String VALID_CONF_FILE                  = "valid-rem-conf.json";
    ...
    public void testInvalidHeaderConfiguration() throws IOException, JsonProcessingException, Exception {
        ...
        ServiceChainRemoveConfig loader = new ServiceChainRemoveConfig();

        try {
            invalidConfHeaderNode = sample.path(APPS)
                        .path(NfvApplicationManager.APP_NAME)
                        .path(NfvApplicationManager.REMOVE_CONFIG_TITLE);

            loader.init(
                appId,
                NfvApplicationManager.REMOVE_CONFIG_TITLE,
    ...
    public void testValidConfiguration() throws IOException, IllegalArgumentException, Exception {
        ...
        Set<ServiceChainId> scConf = loader.undeployServiceChains(appId);
