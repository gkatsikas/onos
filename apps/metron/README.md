...
The right Bazel version for ONOS 1.15.0 (Peacock) is 1.0.0. To install Bazel follow the steps below:
...
[metron-server-apps]: https://github.com/gkatsikas/onos/tree/metron-ctrl-1.15.0/apps/metron/nbi/apps/apps-server-level
[metron-net-apps]: https://github.com/gkatsikas/onos/tree/metron-ctrl-1.15.0/apps/metron/nbi/apps/apps-network-wide
[metron-example-ipclassifier]: https://github.com/gkatsikas/onos/blob/metron-ctrl-1.15.0/apps/metron/nbi/apps/firewall/3rules-flowdisp.json
