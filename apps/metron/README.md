...
This repository provides the source code of ONOS master extended with the Metron controller as an overlay application.
...
To install Bazel version VER (e.g., 1.0.0 for ONOS 2.3.0) follow the steps below:
...
[metron-server-apps]: https://github.com/gkatsikas/onos/tree/metron-ctrl/apps/metron/nbi/apps/apps-server-level
[metron-net-apps]: https://github.com/gkatsikas/onos/tree/metron-ctrl/apps/metron/nbi/apps/apps-network-wide
[metron-example-ipclassifier]: https://github.com/gkatsikas/onos/blob/metron-ctrl/apps/metron/nbi/apps/firewall/3rules-flowdisp.json
