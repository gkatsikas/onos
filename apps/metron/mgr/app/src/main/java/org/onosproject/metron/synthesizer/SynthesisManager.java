...
package org.onosproject.metron.synthesizer;
...
import org.onosproject.metron.processing.Blocks;
...
import static org.onosproject.metron.OsgiPropertyConstants.ENABLE_SYNTHESIZER;
import static org.onosproject.metron.OsgiPropertyConstants.ENABLE_SYNTHESIZER_DEFAULT;
...
@Component(
    immediate = true,
    service = SynthesisService.class,
    property = {
        ENABLE_SYNTHESIZER + ":Boolean=" + ENABLE_SYNTHESIZER_DEFAULT
    }
)
public final class SynthesisManager implements SynthesisService {
    ...
    protected void activate(ComponentContext context) {
        ...
        cfgService.registerProperties(SynthesisManager.class);
    ...
    protected void deactivate(ComponentContext context) {
        ...
        cfgService.unregisterProperties(SynthesisManager.class, false);
