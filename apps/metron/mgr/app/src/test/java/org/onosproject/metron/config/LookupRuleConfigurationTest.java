...
/**
 * Unit test for LookupRuleConfiguration.
 */
public class LookupRuleConfigurationTest {

    @Rule
    public TemporaryFolder testFolder = new TemporaryFolder();

    private static final String NON_EXISTENT_RULE_FILE         = "foo.json";
    private static final String INVALID_RULE_HEADER_FILE       = "lookup/invalid-rule-header.json";
    private static final String INVALID_RULE_CONTENT_TYPO_FILE = "lookup/invalid-rule-content-typo.json";
    private static final String INVALID_RULE_CONTENT_INVL_FILE = "lookup/invalid-rule-content-invl.json";
    private static final String VALID_RULE_FILE                = "lookup/valid-rule.json";
    ...
    private LookupRuleConfiguration badCfgLoader;
    private LookupRuleConfiguration invalidCfgHdrLoader;
    private LookupRuleConfiguration invalidCfgConTypoLoader;
    private LookupRuleConfiguration invalidCfgConInvlLoader;
    private LookupRuleConfiguration validCfgLoader;
    ...
    public void setUp() throws IOException {
        ...
        elemId = "FakeElement";
        appId = new TestApplicationId(0, "LookupRuleConfigurationTest");

        InputStream jsonStream;

        invalidCfgHdrFile = testFolder.newFile("temp1.json");
        jsonStream = LookupRuleConfigurationTest.class.getResourceAsStream(
    ...
    public void badFile() throws IOException, IllegalArgumentException, Exception {
        try {
            badCfgLoader = new LookupRuleConfiguration(
    ...
    public void testInvalidHeaderConfiguration() throws IOException, IllegalArgumentException, Exception {
        invalidCfgHdrLoader = new LookupRuleConfiguration(
    ...
    public void testInvalidContentTypoConfiguration() throws IOException, IllegalArgumentException, Exception {
        invalidCfgConTypoLoader = new LookupRuleConfiguration(
    ...
    /**
     * Checks whether an input rule configurations with correct header attribute,
     * but invalid IP address format is properly detected by loadRules.
     *
     * @throws IOException if the configuration cannot be loaded
     * @throws IllegalArgumentException if the configuration does
     *         not follow the FlowRule template
    ...
    public void testInvalidContentInvlConfiguration() throws IOException, IllegalArgumentException, Exception {
        invalidCfgConInvlLoader = new LookupRuleConfiguration(
        ...
        // Load rules should not work because of bad IP address format.
        try {
            invalidCfgConInvlLoader.loadRules();
        } catch (RuntimeException rtEx) {
            log.info(
                "Successfully caught invalid IP address format in a rule in {}",
        ...
        // If the exception is not caught, then the test fails.
        throw new Exception("Unable to detect bad IP address format in rule");
    }

    /**
     * Checks that a valid LookupRuleConfiguration
    ...
    public void testValidConfiguration() throws IOException, IllegalArgumentException {
        validCfgLoader = new LookupRuleConfiguration(
