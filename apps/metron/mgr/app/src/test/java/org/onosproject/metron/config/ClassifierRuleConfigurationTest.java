...
/**
 * Unit test for ClassifierRuleConfiguration.
 */
public class ClassifierRuleConfigurationTest {

    @Rule
    public TemporaryFolder testFolder = new TemporaryFolder();

    private static final String NON_EXISTENT_RULE_FILE         = "foo.json";
    private static final String INVALID_RULE_HEADER_FILE       = "classifier/invalid-rule-header.json";
    private static final String INVALID_RULE_CONTENT_TYPO_FILE = "classifier/invalid-rule-content-typo.json";
    private static final String INVALID_RULE_CONTENT_INVL_FILE = "classifier/invalid-rule-content-invl.json";
    private static final String VALID_RULE_FILE                = "classifier/valid-rule.json";
    ...
    private ClassifierRuleConfiguration badCfgLoader;
    private ClassifierRuleConfiguration invalidCfgHdrLoader;
    private ClassifierRuleConfiguration invalidCfgConTypoLoader;
    private ClassifierRuleConfiguration invalidCfgConInvlLoader;
    private ClassifierRuleConfiguration validCfgLoader;
    ...
    public void setUp() throws IOException {
        ...
        elemId = "FakeElement";
        appId = new TestApplicationId(0, "ClassifierRuleConfigurationTest");

        InputStream jsonStream;

        invalidCfgHdrFile = testFolder.newFile("temp1.json");
        jsonStream = ClassifierRuleConfigurationTest.class.getResourceAsStream(
    ...
    public void badFile() throws IOException, IllegalArgumentException, Exception {
        try {
            badCfgLoader = new ClassifierRuleConfiguration(
    ...
    public void testInvalidHeaderConfiguration() throws IOException, IllegalArgumentException, Exception {
        invalidCfgHdrLoader = new ClassifierRuleConfiguration(
    ...
    public void testInvalidContentTypoConfiguration() throws IOException, IllegalArgumentException, Exception {
        invalidCfgConTypoLoader = new ClassifierRuleConfiguration(
    ...
    public void testInvalidContentInvlConfiguration() throws IOException, IllegalArgumentException, Exception {
        invalidCfgConInvlLoader = new ClassifierRuleConfiguration(
    ...
    /**
     * Checks that a valid ClassifierRuleConfiguration
    ...
    public void testValidConfiguration() throws IOException, IllegalArgumentException {
        validCfgLoader = new ClassifierRuleConfiguration(
