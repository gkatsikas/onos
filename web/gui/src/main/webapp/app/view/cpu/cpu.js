...
(function () {
    ...
    var topPdg = 28,
        ...
        pName = 'cpu-details-panel',
        detailsReq = 'cpuDetailsRequest',
        detailsResp = 'cpuDetailsResponse';
    ...
    function friendlyPropsList(details) {
        return {
            ...
            'Vendor': details['cpu_vendor'],
            'Frequency': details['cpu_freq'],
            'Status': details['cpu_status'],
            'Load': details['cpu_load'],
        };
    }
    ...
    function populateTop(tblDiv, details) {
        ...
        dps.top().select('h2').text(details.devId + ' cpu ' + details.id);
        ...
        ['$rootScope', '$window', '$timeout', 'KeyService',
            function ($rootScope, $window, $timeout, ks) {
                return function (scope) {
                    ...
                    ks.gestureNotes([
                        ['click', 'Select a row to show CPU details'],
                        ['scroll down', 'See more CPUs'],
                    ]);
